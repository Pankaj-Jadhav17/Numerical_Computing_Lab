...
#include <iomanip>
#include <algorithm>
#include <filesystem>           // ← FIX 1: needed to create output/ directory
...
int main() {
    ...
    // ── FIX 2: create output/ directory if it does not exist ──
    filesystem::create_directories("output");

    // ── FIX 3: open file and immediately check it succeeded ───
